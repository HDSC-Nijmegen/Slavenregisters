...
## matching.R
Contains the matching programs to match certificates between and within series. We matched names of enslaved and mothers with a maximum Levenshtein distance based on the length of the name.
