...
| ---- | ---------------- | --------------- |
| *0. Data selection* | **Filter** </br> - Out event entry 1 is end series *or* event year is last year of series </br> - In event entry 2 is begin series </br> | Select mutations | **Filter** </br> - Out event entry 1 is a transfer </br> - In event entry 2 is a transfer |
