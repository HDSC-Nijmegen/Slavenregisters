  ...
  #open Slave Register
    setwd(wd_SR)
    SR <- fread("Cleaned Registry/cleaned slave register 2022-11-07.txt", encoding="UTF-8")
  ...
  #####################################################
   ...
   #write outfiles
    ...
    cleaned <- fread("Cleaned Registry/cleaned slave register 2022-11-07.txt", encoding="UTF-8")
    ...
    #write outfiles
    write.table(combined, paste0("Reconstituted registry/", Sys.Date(), "SR ER life courses.txt"), quote=F, sep ="\t", col.names=T, row.names=F, fileEncoding="UTF-8")
