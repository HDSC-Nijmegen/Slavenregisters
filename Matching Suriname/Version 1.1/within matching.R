  ...
  match_within <- function(df1, lev_dist_naam, lev_dist_moeder, lev_dist_laglead, NUMMER1){
   ...
   #select entries with EITHER: 
     ...
     # 2 corresponding birth days+months
  ...
  #select entries with EITHER: 
    ...
    # 2 corresponding mutation days+months
  ...
  #add type register
   #source_order_1
    x <- SR[!duplicated(SR$source_order),c("source_order", "Typeregister", "Eigenaar", "Aanvullendeinformatieinschrijv", "Aanvullendeinformatieuitschrij")]
